...
void prime_numbers(int argc, char *argv[])
{
   ...
   c:	68 01 02 00 00       	push   $0x201
  11:	68 78 07 00 00       	push   $0x778
  16:	e8 18 03 00 00       	call   333 <open>
  1b:	89 c6                	mov    %eax,%esi
    for (int i=atoi(argv[1]); i<=atoi(argv[2]); i++)
  1d:	58                   	pop    %eax
  1e:	ff 73 04             	push   0x4(%ebx)
  21:	e8 5a 02 00 00       	call   280 <atoi>
  26:	83 c4 10             	add    $0x10,%esp
  29:	89 c7                	mov    %eax,%edi
  2b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  2f:	90                   	nop
  30:	83 ec 0c             	sub    $0xc,%esp
  33:	ff 73 08             	push   0x8(%ebx)
  36:	e8 45 02 00 00       	call   280 <atoi>
  3b:	83 c4 10             	add    $0x10,%esp
  3e:	39 f8                	cmp    %edi,%eax
  40:	7c 4e                	jl     90 <prime_numbers+0x90>
        {
        int flag=0;
        for (int j=2; j<i; j++)
  42:	83 ff 02             	cmp    $0x2,%edi
  45:	7e 29                	jle    70 <prime_numbers+0x70>
            if (i%j == 0)
  47:	f7 c7 01 00 00 00    	test   $0x1,%edi
  4d:	74 33                	je     82 <prime_numbers+0x82>
        for (int j=2; j<i; j++)
  4f:	b9 02 00 00 00       	mov    $0x2,%ecx
  54:	eb 13                	jmp    69 <prime_numbers+0x69>
  ...
  67:	74 19                	je     82 <prime_numbers+0x82>
        for (int j=2; j<i; j++)
  69:	83 c1 01             	add    $0x1,%ecx
  6c:	39 cf                	cmp    %ecx,%edi
  6e:	75 f0                	jne    60 <prime_numbers+0x60>
                flag =1;
                break;
            }
        if (flag==0)
  ...
  73:	57                   	push   %edi
  74:	68 8a 07 00 00       	push   $0x78a
  79:	56                   	push   %esi
  7a:	e8 d1 03 00 00       	call   450 <printf>
  7f:	83 c4 10             	add    $0x10,%esp
    for (int i=atoi(argv[1]); i<=atoi(argv[2]); i++)
  82:	83 c7 01             	add    $0x1,%edi
  85:	eb a9                	jmp    30 <prime_numbers+0x30>
  ...
  93:	56                   	push   %esi
  94:	e8 82 02 00 00       	call   31b <close>
    exit();
 ...
 459:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5d7:	90                   	nop
          s = "(null)";
 5d8:	ba 8e 07 00 00       	mov    $0x78e,%edx
        while(*s != 0){
