...
main(void)
{
  ...
  cc:	50                   	push   %eax
  cd:	50                   	push   %eax
  ce:	68 98 0b 00 00       	push   $0xb98
  d3:	68 6a 08 00 00       	push   $0x86a
  d8:	e8 ce 02 00 00       	call   3ab <exec>
      printf(1, "init: exec sh failed\n");
  dd:	5a                   	pop    %edx
  de:	59                   	pop    %ecx
  df:	68 6d 08 00 00       	push   $0x86d
  e4:	6a 01                	push   $0x1
 ...
 4d9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 549:	ff 24 85 94 08 00 00 	jmp    *0x894(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 657:	90                   	nop
          s = "(null)";
 658:	ba 8c 08 00 00       	mov    $0x88c,%edx
        while(*s != 0){
 ...
 671:	a1 a0 0b 00 00       	mov    0xba0,%eax
{
 ...
 6b1:	5b                   	pop    %ebx
  freep = p;
 6b2:	89 15 a0 0b 00 00    	mov    %edx,0xba0
}
 6b8:	5e                   	pop    %esi
 6b9:	5f                   	pop    %edi
 6ba:	5d                   	pop    %ebp
 ...
 6e9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ec:	89 15 a0 0b 00 00    	mov    %edx,0xba0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 74f:	73 4f                	jae    7a0 <malloc+0xa0>
    ...
    if(p == freep)
 751:	8b 3d a0 0b 00 00    	mov    0xba0,%edi
 ...
 77a:	e8 f1 fe ff ff       	call   670 <free>
  return freep;
 77f:	8b 15 a0 0b 00 00    	mov    0xba0,%edx
 ...
 7ac:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7af:	89 15 a0 0b 00 00    	mov    %edx,0xba0
}
 ...
 7bf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7c0:	c7 05 a0 0b 00 00 a4 	movl   $0xba4,0xba0
 7c7:	0b 00 00 
    base.s.size = 0;
 7ca:	bf a4 0b 00 00       	mov    $0xba4,%edi
    base.s.ptr = freep = prevp = &base;
 7cf:	c7 05 a4 0b 00 00 a4 	movl   $0xba4,0xba4
 7d6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7d9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7db:	c7 05 a8 0b 00 00 00 	movl   $0x0,0xba8
 7e2:	00 00 00 
    if(p->s.size >= nunits){
